...
Completed as the capstone of the IBM Data Science Professional Certificate.
...
Language: Python Data: pandas, NumPy, SQL (SQLite) Visualization: Matplotlib, Seaborn, Plotly, Folium Dashboard: Plotly Dash Machine Learning: scikit-learn Collection: SpaceX REST API, BeautifulSoup (web scraping)

👤 Author

Mohamed Zaatour Computer Science student — Big Data & Data Analysis, ISAMM
